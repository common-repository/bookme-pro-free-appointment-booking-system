        ...
        foreach ( $sources as $source => $files ) {
            switch ( $source ) {
                case 'wp':
                    ...
                    break;
                case 'backend':
                    $path = $plugin_class::getDirectory() . '/backend/assets/path';
                    break;
                case 'frontend':
                    $path = $plugin_class::getDirectory() . '/frontend/assets/path';
                    break;
                case 'module':
                    $path = $this->getModuleDirectory() . '/assets/path';
                    break;
                case 'bookme_pro':
            ...
            foreach ( $files as $key => $value ) {
                ...
                if ( $path === false ) {
                    ...
                    call_user_func( $func, 'bookme-pro-' . basename( $file ), plugins_url( $file, $path ), $deps, $assets_version );
                }
            }
        }
    }
