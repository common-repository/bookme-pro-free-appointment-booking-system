...
<div id="bookme-pro-tbs" class="wrap">
    <div class="bookme-pro-tbs-body">
        <?php \BookmePro\Lib\Utils\Common::pageHeader('Data management'); ?>
        ...
        <div class="panel-group" id="data-management">
            <div class="bookme-pro-data-button">
            <form action="<?php echo admin_url( 'admin-ajax.php?action=bookme_pro_export_data' ) ?>" method="POST">
                <?php \BookmePro\Lib\Utils\Common::csrf() ?>
                <button id="bookme-pro-export" type="submit" class="btn btn-lg btn-primary">
                    <span class="ladda-label">Export data</span>
                </button>
            </form>
            </div>
            <div class="bookme-pro-data-button">
            <form id="bookme_pro_import" action="<?php echo admin_url( 'admin-ajax.php?action=bookme_pro_import_data' ) ?>" method="POST" enctype="multipart/form-data">
                <?php \BookmePro\Lib\Utils\Common::csrf() ?>
                <div id="bookme-pro-import" class="btn btn-lg btn-primary btn-file">
                    <span class="ladda-label">Import data</span>
                    <input type="file" id="bookme_pro_import_file" name="import">
                </div>
            </form>
          </div>
        </div>
