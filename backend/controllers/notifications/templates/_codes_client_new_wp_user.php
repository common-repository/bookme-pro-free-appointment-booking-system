...
$codes = array(
    ...
    array('code' => 'new_username', 'description' => esc_html__('customer new username', 'bookme_pro')),
    array('code' => 'new_password', 'description' => esc_html__('customer new password', 'bookme_pro')),
    array('code' => 'site_address', 'description' => esc_html__('site address', 'bookme_pro')),
);
