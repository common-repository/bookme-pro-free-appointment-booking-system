...
$codes = array(
    ...
    array('code' => 'cancel_appointment', 'description' => esc_html__('cancel appointment link', 'bookme_pro')),
    array('code' => 'cancel_appointment_url', 'description' => esc_html__('URL of cancel appointment link (to use inside <a> tag)', 'bookme_pro')),
    array('code' => 'cancellation_reason', 'description' => esc_html__('reason you mentioned while deleting appointment', 'bookme_pro')),
    ...
    array('code' => 'custom_fields_2c', 'description' => esc_html__('combined values of all custom fields (formatted in 2 columns)', 'bookme_pro')),
    ...
    array('code' => 'staff_photo', 'description' => esc_html__('photo of staff', 'bookme_pro')),
