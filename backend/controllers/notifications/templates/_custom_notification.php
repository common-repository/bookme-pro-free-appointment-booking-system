    ...
    <div id="collapse_<?php echo $id ?>" class="panel-collapse collapse">
        <div class="panel-body">
                            ...
                            <div class="form-inline bookme-pro-margin-bottom-sm">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="<?php echo $name ?>[offset_hours]">
                                        ...
                                        <?php endforeach ?>
                                        <option value="43200" <?php selected( @$settings['offset_hours'], 43200 ) ?>>30 <?php esc_html_e( 'days', 'bookme_pro' ) ?></option>
                                    </select>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="notification_<?php echo $id ?>_subject"><?php esc_html_e( 'Subject', 'bookme_pro' ) ?></label>
